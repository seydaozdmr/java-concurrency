...
public class ImprovedList <T> implements List<T> {
     ...
     * its own consistent locking that provides
     * thread safety even if the List is not thread-safe or changes its locking implementation.
     */
